...
// @public
export const setGlobalTheme: ({ colorMode, dark, light, shape, spacing, typography, }?: Partial<ThemeState>, themeLoader?: ((id: ThemeIdsWithOverrides) => Promise<void> | void) | undefined) => Promise<UnbindFn>;
...
// @public (undocumented)
const themeIdsWithOverrides: readonly ["light", "dark", "legacy-light", "legacy-dark", "spacing", "typography", "shape", "light-new-input-border", "dark-new-input-border"];
