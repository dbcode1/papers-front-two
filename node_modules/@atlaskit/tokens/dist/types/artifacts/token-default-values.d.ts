...
declare const defaultTokenValues: {
    ...
    readonly 'color.chart.categorical.5.hovered': "#092957";
    ...
    readonly 'color.chart.categorical.7.hovered': "#421F34";
    ...
    readonly 'color.chart.lime.bolder.hovered': "#4C6B1F";
    readonly 'color.chart.lime.boldest': "#4C6B1F";
    ...
    readonly 'elevation.shadow.overflow': "0px 0px 8px #091E4229, 0px 0px 1px #091E421F";
